...
:::
:::
- I am working on the application of ASTROMER architecture proposed [here](https://arxiv.org/pdf/2205.01677.pdf) on spectral data derived from stars, galaxies and quasars. Currently, my aim is to extract spectra embeddings by training ASTROMER in a self supervised manner.
...
:::
:::
  - **Aim**: To extract spectra embeddings by training [ASTROMER](https://arxiv.org/pdf/2205.01677.pdf) in a self supervised manner.
